...
**Fluxos Alternativos**  
- 1a. Esqueci minha senha → Recuperar Senha (**extend**).  
- 2a. Usuário bloqueado → contato do suporte.  
...
- 4a. Envio de boas-vindas → UC-07 (**extend**).  
...
- 4a. Notificar Psicólogo sobre ativação → UC-07 (**extend**).  
...
- 4a. Sincronizar calendário externo → UC-07 (**extend**).  
...
**Fluxos Alternativos**  
- 2a. Sem disponibilidade → lista de espera (**extend**).  
- 4a. Pagamento exigido → UC-09 (**include**).  
...
- 3a. Enviar notificação → UC-07 (**extend**).  
...
- 3a. Confirmação de presença → UC-05 (**include**).  
...
- 4a. Assinatura digital → UC-12 (**extend**).  
...
- 1a. Política de reembolso → UC-06 (**extend**).  
...
- 3a. Agendar lembrete de retorno → UC-07 (**include**).  
...
**Fluxos Alternativos**  
- 2a. Consentimento essencial ausente → bloqueia recurso (**extend**).  
...
- 3b. Exportar relatório → UC-13 (**extend**).  
...
- 3a. Agendar envio automático → UC-07 (**extend**).  
...
**Fluxos Alternativos**  
- 2a. Solicitar portabilidade → UC-11 (**extend**).  
...
**Fluxos Alternativos**  
- 2a. Elegibilidade negada → ofertar pagamento particular (**extend**).